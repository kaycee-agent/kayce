...
st.markdown("""
            ...
            * using base64, pandas, streamlit **Python libraries**
            * **Reference:** [Basketball-reference.com](https://www.basketball-reference.com) 
            """)
